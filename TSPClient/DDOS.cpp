...
void CDDOS::OnActivateView(BOOL bActivate, CView* pActivateView, CView* pDeactiveView) 
{
	...
	{
		DDOS_Flag = 0x0;
		SetDlgItemText( IDC_URL, "127.0.0.1" );
		SetDlgItemText( IDC_PORT, "80" );
		SetDlgItemText( IDC_FaBao, "30" );
		SetDlgItemText( IDC_SLEEP, "100" );
		SetDlgItemText( IDC_ATTACKTIME, "0" );
		SetDlgItemText( IDC_Thread, "5" );
		SetDlgItemText( IDC_BIANCAN1, "0" );
		SetDlgItemText( IDC_BIANCAN2, "1" );
		SetDlgItemText( IDC_GETPAGE, "/" );
	}
